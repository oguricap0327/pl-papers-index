...
Papers indexed from OOPSLA (Object-Oriented Programming, Systems, Languages, and Applications).
OOPSLA papers appear in PACMPL (Proceedings of the ACM on Programming Languages).
